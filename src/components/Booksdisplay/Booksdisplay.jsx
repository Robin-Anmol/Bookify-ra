  ...
  return (
    <>
      ...
      <div className={gridview ? "booksdisplay gridbooks" : "booksdisplay"}>
       ...
       <div className="filters box-shadow-br">
          <div className="top">
              <h3>Good Morning Joshua</h3>
              <div className="userdisplay flexrow ac">
                <i className="fal fa-user-circle"></i>
                <button><i className="fal fa-user"></i> My Account</button>
              </div>
          </div>
          <hr/>
          <div className="mediafilters flexrow">
        <Filtericons state2={false} />
            {saved? <Label icon='fal fa-bookmark' text='Saved' keyword={keyword} setKeyword={setKeyword}  state2={true}/>:''}
